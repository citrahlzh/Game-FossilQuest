...
extension GetFossilDataCollection on Isar {
  IsarCollection<FossilData> get fossilDatas => this.collection();
}

const FossilDataSchema = CollectionSchema(
  name: r'FossilData',
  id: -8208373613114769607,
  properties: {
  ...
  estimateSize: _fossilDataEstimateSize,
  serialize: _fossilDataSerialize,
  deserialize: _fossilDataDeserialize,
  deserializeProp: _fossilDataDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _fossilDataGetId,
  getLinks: _fossilDataGetLinks,
  attach: _fossilDataAttach,
  version: '3.1.0+1',
);

int _fossilDataEstimateSize(
  FossilData object,
  List<int> offsets,
...
FossilData _fossilDataDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _fossilDataDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _fossilDataGetId(FossilData object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _fossilDataGetLinks(FossilData object) {
  return [];
}

void _fossilDataAttach(IsarCollection<dynamic> col, Id id, FossilData object) {
  object.id = id;
}

extension FossilDataQueryWhereSort
    on QueryBuilder<FossilData, FossilData, QWhere> {
...
extension FossilDataQueryWhere
    on QueryBuilder<FossilData, FossilData, QWhereClause> {
...
extension FossilDataQueryFilter
    on QueryBuilder<FossilData, FossilData, QFilterCondition> {
  QueryBuilder<FossilData, FossilData, QAfterFilterCondition>
      descriptionEqualTo(
    String value, {
  ...
  QueryBuilder<FossilData, FossilData, QAfterFilterCondition> idEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<FossilData, FossilData, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
...
extension FossilDataQueryObject
    on QueryBuilder<FossilData, FossilData, QFilterCondition> {}

extension FossilDataQueryLinks
    on QueryBuilder<FossilData, FossilData, QFilterCondition> {}

extension FossilDataQuerySortBy
    on QueryBuilder<FossilData, FossilData, QSortBy> {
...
extension FossilDataQuerySortThenBy
    on QueryBuilder<FossilData, FossilData, QSortThenBy> {
...
extension FossilDataQueryWhereDistinct
    on QueryBuilder<FossilData, FossilData, QDistinct> {
...
extension FossilDataQueryProperty
    on QueryBuilder<FossilData, FossilData, QQueryProperty> {
