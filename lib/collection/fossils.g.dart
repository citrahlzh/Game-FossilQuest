...
const FossilSchema = CollectionSchema(
  ...
  estimateSize: _fossilEstimateSize,
  serialize: _fossilSerialize,
  deserialize: _fossilDeserialize,
  deserializeProp: _fossilDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
  getId: _fossilGetId,
  getLinks: _fossilGetLinks,
  attach: _fossilAttach,
  version: '3.1.0+1',
);
