...
final List<Fossil> fossils = [
  Fossil(
      name: 'Daun',
      imagePath: '../../assets/images/fossil/daun.png',
      description: 'Daun'),
  Fossil(
      name: 'Ikan',
  ...
  Fossil(
      name: 'Kepala',
      imagePath: '../../assets/images/fosasil/kepala.png',
      description: 'Kepala'),
  Fossil(
      name: 'Kerang',
      imagePath: '../../assets/images/fossil/kerang.png',
      description: 'Kerang'),
  Fossil(
      name: 'Mosasaurus',
      imagePath: '../../assets/images/fossil/mosasaurus.png',
      description:
  ...
  Fossil(
      name: 'Ornithopoda',
      imagePath: '../../assets/images/fossil/ornithopoda.png',
      description:
  ...
  Fossil(
      name: 'Pteranodon',
      imagePath: '../../assets/images/fossil/pteranodon.png',
      description:
  ...
  Fossil(
      name: 'Tylosaurus',
      imagePath: '../../assets/images/fossil/tylosaurus.png',
      description:
  ...
  Fossil(
      name: 'Tyrannosaurus',
      imagePath: '../../assets/images/fossil/tyrannosaurus.png',
      description:
  ...
  Fossil(
      name: 'Velociraptor',
      imagePath: '../../assets/images/fossil/velociraptor.png',
      description:
